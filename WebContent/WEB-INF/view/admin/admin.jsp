...
<head>
    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						{"menuid":"1","icon":"","menuname":"绩效统计分析",
							"menus":[
									{"menuid":"11","menuname":"考核列表","icon":"icon-exam","url":"ExamServlet?method=toExamListView"}
								]
						},
						...
						{"menuid":"3","icon":"","menuname":"领导信息管理",
							"menus":[
									{"menuid":"31","menuname":"领导列表","icon":"icon-user-teacher","url":"TeacherServlet?method=toTeacherListView"},
								]
						},
						{"menuid":"4","icon":"","menuname":"基础信息管理",
							"menus":[
									{"menuid":"41","menuname":"部门列表","icon":"icon-world","url":"GradeServlet?method=toGradeListView"},
									{"menuid":"42","menuname":"小组列表","icon":"icon-house","url":"ClazzServlet?method=toClazzListView"},
									{"menuid":"43","menuname":"考核项目列表","icon":"icon-book-open","url":"CourseServlet?method=toCourseListView"}
								]
						},
						{"menuid":"6","icon":"","menuname":"请假信息管理",
							"menus":[
									{"menuid":"61","menuname":"请假列表","icon":"icon-book-open","url":"LeaveServlet?method=toLeaveListView"},
								]
						},
...
<body class="easyui-layout" style="overflow-y: hidden"  scroll="no">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; ">JLUZH员工绩效考核系统</span>
    </div>
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">Copyright &copy; JLUZH By 巫晓婷</div>
    </div>
