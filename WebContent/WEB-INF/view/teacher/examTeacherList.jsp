...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'name',title:'考核名称',width:200, sortable: true},    
 		        {field:'etime',title:'考核时间',width:150},
 		        ...
 		        {field:'grade',title:'考核部门',width:100, 
 		        	formatter: function(value,row,index){
 						if (row.grade){
 		        ...
 		        {field:'clazz',title:'考核小组',width:100, 
 		        	formatter: function(value,row,index){
 						if (row.clazz){
	    	...
	    	$.ajax({
				...
				success: function(result){
					...
					if(courseList.length == 0){
						$.messager.alert("消息提醒", "您没有考核项目", "warning");
					} else{
						table = $("#addTable");
	    ...
	    $("#register").click(function(){
        	...
        	if(exam == null){
            	$.messager.alert("消息提醒", "请选择考核进行统计!", "warning");
            } else{
				...
				$.ajax({
					...
					success: function(result){
						...
						for(var i = 0;i < courseList.length;i++){
							...
							//添加到表格显示
							var tr = $("<tr class='chooseTr'><td>考核项目:</td></tr>");
	    ...
	    $("#escoreList, #regEscoreList").datagrid({ 
   	        ...
   	        remoteSort: false,
   	        frozenColumns: [[  
   				{field:'number',title:'工号',width:120,resizable: false},    
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left;"><a id="register" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-vcard-edit',plain:true">登记绩效</a></div>
			<div style="float: left;" class="datagrid-btn-separator"></div>
		<div><a id="escore" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-chart_bar',plain:true">绩效统计</a></div>
	</div>
	...
	<div id="escoreToolbar">
		...
		<span id="escoreClazzSpan" style="margin-left:10px;">工作小组：<input id="escoreClazzList" class="easyui-textbox" name="clazz" /></span>
	</div>
	...
	<div id="regEscoreToolbar">
		...
		<span id="regClazzSpan" style="margin-left:10px;">工作小组：<input id="regClazzList" class="easyui-textbox" name="clazz" /></span>
		<span id="regCourseSpan" style="margin-left:10px;">考核项目：<input id="regCourseList" class="easyui-textbox" name="course" /></span>
	</div>
    	...
    	<form id="addForm" method="post">
	    	<table id="addTable" border=0 style="width:800px; table-layout:fixed;" cellpadding="6"  >
	    		...
	    		<tr>
	    			<td>考核<br/>类型:</td>
	    			<td>
	    				<input style="width: 200px; height: 30px;" class="easyui-textbox" data-options="readonly: true" type="text" value="平时考核" />
