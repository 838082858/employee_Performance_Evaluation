	...
	$(function(){
		...
		$("#submitBtn").click(function(){
			...
			if($("#radio-3").attr("checked") && "${systemInfo.forbidTeacher}" == 1){
				$.messager.alert("消息提醒", "领导暂不能登录系统！", "warning");
				return;
			}
    ...
    <form id="form" class="form form-horizontal" method="post">
      <div class="row cl">
        ...
        <div class="formControls col-8">
          <input id="" name="account" type="text" placeholder="用户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-3"><i class="Hui-iconfont">&#xe60e;</i></label>
...
<div class="footer">Copyright &nbsp; JLUZH @ wuxiaoting </div>
