	...
	$(function() {	
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectRow == null){
            	...
            	var id = selectRow.id;
            	$.messager.confirm("消息提醒", "将删除与本次考核相关的所有绩效，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
	    ...
	    $('#escoreList').datagrid({ 
   	        ...
   	        frozenColumns: [[  
   				{field:'number',title:'工作号',width:120,resizable: false,sortable: false},    
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left;"><a id="delete" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-some-delete',plain:true">删除</a></div>
			<div style="float: left;" class="datagrid-btn-separator"></div>
		<div style="float: left;"><a id="escore" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-chart_bar',plain:true">绩效统计</a></div>
		
		<div style="float: left; margin: 0 10px 0 10px">部门：<input id="gradeList" class="easyui-textbox" name="grade" /></div>
		<div style="margin-left: 10px;">工作小组：<input id="clazzList" class="easyui-textbox" name="clazz" /></div>
	</div>
	...
	<div id="escoreToolbar">
		...
		<span style="margin-left:10px;">工作小组：<input id="escoreClazzList" class="easyui-textbox" name="clazz" /></span>
	</div>
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>考核类型:</td>
	    			<td>
	    				<input style="width: 200px; height: 30px;" class="easyui-textbox" data-options="readonly: true" type="text" value="季度考核" />
