	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'courseList',title:'部门考核项目',width:650, 
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectRow == null){
            	...
            	$.messager.confirm("消息提醒", "将删除与部门相关的所有数据(包括工作小组,员工)，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
	...
	<div id="addDialog" style="padding: 10px">  
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>选择考核项目:</td>
	    			<td><select id="add_courseList" style="width: 200px; height: 30px;" name="clazzid" data-options="required:true, missingMessage:'请选择考核项目'" ></select></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
