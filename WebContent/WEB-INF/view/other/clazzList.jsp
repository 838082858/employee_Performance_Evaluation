	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'name',title:'工作小组名称',width:200},
 		        {field:'grade',title:'所属部门',width:100, 
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectRow == null){
            	...
            	$.messager.confirm("消息提醒", "将删除与工作小组相关的所有数据(包括员工)，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
...
<body>
	...
	<div id="toolbar">
		...
		<div style="margin: 0 10px 0 10px">部门：<input id="gradeList" class="easyui-textbox" name="grade" /></div>
	</div>
