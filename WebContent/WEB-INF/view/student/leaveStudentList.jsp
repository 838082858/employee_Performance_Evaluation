...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"LeaveServlet?method=LeaveStudentList&t="+new Date().getTime(),
	        idField:'id', 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        {field:'id',title:'ID',width:50, sortable: true},    
 		       	{field:'studentID',title:'员工',width:200,
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		<tr>
	    			...
	    			<td colspan="3">
	    				<input id="add_studentList" style="width: 300px; height: 30px;" class="easyui-textbox" name="studentid" data-options="required:true, missingMessage:'请选择员工信息'" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>请假原因:</td>
    	...
    	<form id="editForm" method="post">
	    	<table cellpadding="8" >
	    		<tr>
	    			<td style="width:60px">员工:</td>
	    			<td colspan="3">
	    				<input id="edit_studentList" style="width: 300px; height: 30px;" class="easyui-textbox" name="studentid" data-options="required:true, missingMessage:'请选择员工信息'" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>请假原因:</td>
