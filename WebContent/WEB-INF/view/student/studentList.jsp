	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'number',title:'工号',width:200, sortable: true},    
 		        {field:'name',title:'姓名',width:200},
 		        {field:'sex',title:'性别',width:100},
 		        {field:'phone',title:'电话',width:150},
 		        {field:'qq',title:'QQ',width:150},
 		        {field:'clazz',title:'工作小组',width:150, 
 		        ...
 		        {field:'grade',title:'部门',width:150, 
					formatter: function(value,row,index){
 						if (row.grade){
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "将删除与员工相关的所有数据(包括绩效)，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
    	...
    	<form id="editForm" method="post">
	    	<table cellpadding="8" >
	    		<tr>
	    			<td>工号:</td>
	    			<td>
	    				<input id="edit_number" data-options="readonly: true" class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="number" data-options="required:true, validType:'repeat', missingMessage:'请输入工号'" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>姓名:</td>
